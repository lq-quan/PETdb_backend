...
public class DataSetUploadController {
     ...
     **/
    @PostMapping("/PETdatabase/dataset/manage/uploadinfo")
     ...
     **/
    @PostMapping("/PETdatabase/dataset/manage/update")
     ...
     **/
    @PostMapping("/PETdatabase/dataset/manage/uploadLocal")
     ...
     **/
    @PostMapping("/PETdatabase/dataset/manage/mergefile")
     ...
     **/
    @GetMapping("/PETdatabase/dataset/manage/checkmd5")
    public Result checkMd5(FilePart part){
        if(part.getFileName() == null || part.getFileName().length() > 256) return Result.error("文件名过长", 40012);
        UploadLocalRes res = new UploadLocalRes();
